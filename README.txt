...
- tun_mtu controls the tunnel interface MTU and defaults to 1400
...
- keep the router-to-gateway ethernet MTU at its normal value (usually 1500); do not copy tun_mtu to the router WAN interface
